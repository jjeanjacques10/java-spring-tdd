...
public class BookingServiceTest {
    ...
    public void setup() {
        ...
        BookingModel bookingModel = new BookingModel("1", "Jean", checkIn, checkOut, 10);
